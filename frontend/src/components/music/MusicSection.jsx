      ...
      <AnimatePresence mode="wait">
        {activeTab === 'search' && !selectedPlaylist ? (
          ...
          >
            ...
            <div className="music-welcome-content relative h-full flex flex-col items-center justify-end md:justify-center text-center space-y-4 sm:space-y-5 p-6 sm:p-8 pb-8 sm:pb-10">
