  ...
  return (
    <>
      ...
      <div className="relative mt-4 md:mt-0 md:flex md:gap-4 md:px-0 md:overflow-visible">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {currentCard.type === 'achievements' && user && (
                    <motion.div 
                      className="relative rounded-3xl p-6 overflow-hidden border border-white/10 cursor-pointer"
                      style={{ 
                        backgroundColor: 'rgba(52, 52, 52, 0.7)',
                        backdropFilter: 'blur(40px) saturate(180%)',
                        WebkitBackdropFilter: 'blur(40px) saturate(180%)',
        ...
        <div 
          className="absolute right-[6px] top-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-3 md:hidden z-10"
        >
          {/* Кнопка вверх */}
          <motion.button
